...
use App\Observers\ScopeOfWorkObserver;
...
class ScopeOfWork extends BaseModel
{
    ...
    protected static function boot()
    {
        ...
        static::observe(ScopeOfWorkObserver::class);
...
//            $zero = $invoiceSettings->estimate_prefix . '#' . $zero . $value;
    ...
    {
        $invoice = DB::select('SELECT MAX(CAST(`estimate_number` as UNSIGNED)) as estimate_number FROM `scope_of_works`');
