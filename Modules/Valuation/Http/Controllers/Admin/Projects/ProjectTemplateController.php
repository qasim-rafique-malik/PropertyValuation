...
namespace Modules\Valuation\Http\Controllers\Admin\Projects;
...
class ProjectTemplateController extends ValuationAdminBaseController
{

    private $viewFolderPath = 'valuation::Admin.Projects.ProjectTemplate.';

    private $listingPageRoute = 'valuation.admin.property';
    private $dataRoute = 'valuation.admin.project.templates.data';
