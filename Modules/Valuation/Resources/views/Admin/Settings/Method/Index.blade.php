        ...
        <div class="col-lg-8 col-md-5 col-sm-6 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __($pageTitle) }}
                <span class="text-info b-l p-l-10 m-l-5">{{ $fetureCount }}</span> <span
                        class="font-12 text-muted m-l-5"> @lang('valuation::valuation.valuationMethod.totalFeture')</span>
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('valuation::valuation.valuationMethod.name')</th>
                                        <th>@lang('valuation::valuation.valuationMethod.category')</th>
