...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-4 col-sm-6 col-md-7 col-xs-12 text-right">
            <a href="{{ route($addEditViewRoute) }}" class="btn btn-outline btn-success btn-sm">@lang('valuation::valuation.valuationApproach.createCategory') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('valuation::valuation.valuationApproach.categoryName')</th>
