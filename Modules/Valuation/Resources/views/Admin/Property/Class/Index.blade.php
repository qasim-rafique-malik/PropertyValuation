    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-8 col-md-5 col-sm-6 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> {{ __($pageTitle) }}
                <span class="text-info b-l p-l-10 m-l-5">{{ $propertyClassCount }}</span> <span
                        class="font-12 text-muted m-l-5"> @lang('valuation::valuation.property.class.total')</span>
            </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-4 col-sm-6 col-md-7 col-xs-12 text-right">
            <a href="{{ route($addEditViewRoute) }}" class="btn btn-outline btn-success btn-sm">@lang('valuation::valuation.property.class.createPropertyClass') <i class="fa fa-plus" aria-hidden="true"></i></a>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable"
                        ...
                        <tr>
                            ...
                            <th>@lang('valuation::valuation.property.class.title')</th>
