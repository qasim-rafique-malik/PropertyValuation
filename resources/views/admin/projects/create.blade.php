                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-4 ">
                                    <div class="form-group">
                                        <label class="control-label">@lang('app.menu.template')</label>
                                        <select class="selectpicker form-control" name="template_id" id="template_id"
                                            ...
                                            <option value=""></option>
                                            @forelse($templates as $template)
                                                <option value="{{$template->id}}"> {{ ucwords($template->project_name) }}</option>
                                            @empty
...
{{--                                            <label for="client_view_task">@lang('modules.projects.clientViewTask')</label>--}}
                            ...
                            {{-- <h3 class="box-title m-b-30">Properties</h3>--}}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="currency_id" id="" class="form-control select2">
                                            @foreach ($currencies as $item)
                                                <option
                                                        ...
                                                        selected
                                                        @endif
                                                        value="{{ $item->id }}">{{ $item->currency_name }}
                                                    ({{ $item->currency_code }})
                                                </option>
                                            @endforeach
                                        </select>
