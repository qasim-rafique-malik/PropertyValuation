                    ...
                    @if(!module_enabled('RestAPI'))
                        @if($cachedFile)
                            ...
                            <a href="javascript:;" id="clear-cache"
                               class="btn btn-sm btn-danger pull-right m-l-5 text-white"><i
                                        class="fa fa-times"></i> @lang('app.disableCache')</a>
                            <h6 class="text-white pull-right m-r-5">@lang('messages.cacheEnabled')</h6>
                        @else


                            <a href="javascript:;" id="refresh-cache"
                               class="btn btn-sm btn-success pull-right text-white">
                                <i
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-4 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label">@lang('modules.accountSettings.enableGoogleRecaptcha')
                                        ...
                                        <div class="col-sm-12 col-md-4 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="google_recaptcha_key" name="google_recaptcha_key"
