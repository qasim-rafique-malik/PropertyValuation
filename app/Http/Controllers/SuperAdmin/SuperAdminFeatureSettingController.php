...
class SuperAdminFeatureSettingController extends SuperAdminBaseController
{
    ...
    public function updateTitles(UpdateTitleRequest $request)
    {
        ...
        if($request->type == 'task')    {
            $data['task_management_title']  = $request->title;
            $data['task_management_detail'] = $request->detail;
        }
        elseif($request->type == 'bills'){
            $data['manage_bills_title']  = $request->title;
            $data['manage_bills_detail'] = $request->detail;
        }
        elseif($request->type == 'image'){
            $data['feature_title']       = $request->title;
            $data['feature_description'] = $request->detail;
        }
        elseif($request->type == 'team'){
            $data['teamates_title']  = $request->title;
            $data['teamates_detail'] = $request->detail;
        }
        elseif($request->type == 'apps'){
            $data['favourite_apps_title']  = $request->title;
            $data['favourite_apps_detail'] = $request->detail;
        }
