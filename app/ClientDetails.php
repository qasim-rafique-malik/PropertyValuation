...
class ClientDetails extends BaseModel
{
    ...
    protected $fillable = ['company_name','name','email','user_id','address','website','note','skype','facebook','twitter','linkedin','gst_number', 'shipping_address', 'email_notifications','office_phone','city','state','postal_code'];
